package com.daicy.crawler.core.plugin.descriptor;
...
public class PluginDescriptor {
	...
	public static PluginDescriptor fromXMLStream(InputStream xmlInputStream) {
		com.daicy.crawler.core.plugin.descriptor.jaxb.generated.PluginDescriptor pluginDescriptor =
				null;
		try {
			JAXBContext jc =
					JAXBContext.newInstance("com.daicy.crawler.core.plugin.descriptor.jaxb.generated");
			Unmarshaller u = jc.createUnmarshaller();
			pluginDescriptor =
					(com.daicy.crawler.core.plugin.descriptor.jaxb.generated.PluginDescriptor) u
	...
	private static PluginDescriptor fromJaxbPluginDescriptor(
			com.daicy.crawler.core.plugin.descriptor.jaxb.generated.PluginDescriptor source) {
		...
		if (source.getParameters() != null) {
			for (com.daicy.crawler.core.plugin.descriptor.jaxb.generated.Parameter parameter : source
