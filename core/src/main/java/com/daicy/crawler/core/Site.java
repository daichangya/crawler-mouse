...
public class Site {
    ...
    private boolean userProxyProvider = false;
    ...
    public Site setUseRealBrowser(boolean useRealBrowser) {
    ...
    public Site setBrowserType(BrowserType browserType) {
        this.browserType = browserType;
        return this;
    }

    public boolean isUserProxyProvider() {
        return userProxyProvider;
    }

    public void setUserProxyProvider(boolean userProxyProvider) {
