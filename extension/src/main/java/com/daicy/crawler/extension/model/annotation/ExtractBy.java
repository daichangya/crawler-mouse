package com.daicy.crawler.extension.model.annotation;
...
public @interface ExtractBy {
     ...
     * types of value
     */
    public static enum ValueType {Text,Image}

    /**
     * value type, support Text, Image.
     *
    ...
    /**
     * ValueType Image is download .<br>
     * If set to 'true' download Image. <br>
     *
     * @return isDownLoad
     */
