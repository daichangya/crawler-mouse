package com.daicy.crawler.web.enorth;
...
public class EnorthModel {

    private static Logger logger = LoggerFactory.getLogger(EnorthModel.class);
    ...
    public static Spider baiduIndexBuild(String cookie) {
        ...
        Spider spider = OOSpider.create(site
                , new CsvFileModelPipeline(), EnorthModel.class).addRequest(urlList.toArray(new Request[0])).thread(1)
                .setFilters(filters);
        return spider;
    }
